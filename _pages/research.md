...
- [**Signed, Sealed, Delivered: Digital Receipts in the Ugandan Dairy Chain**](https://github.com/pmasae/pmasae.github.io/blob/changes/_publications/PFMS_JMP.pdf) — with [David Henning](https://djhenning.github.io/)
  ...
  - *Presented at: MWIEDC 2026 (scheduled)*, PacDev 2026 *(scheduled)*, CSAE 2026 *(scheduled)*, PSDRN Seminar Series 2025-2026 *(scheduled)*, MAE 2026 *(scheduled)*, World Bank–KDI School Development Impact Conference, AFE 2025, AAEA & WAEA 2025
...
- **Banking Amidst Conflict: How Violence Shapes Financial Inclusion in Mexico** -- with Xiaofei Wang (Draft in progress)
	...
	**Abstract:** 
	We study how exposure to violence shapes the use of formal financial services in Mexico. Using administrative records on violent incidents, we construct municipality-level out-of-sample predictions of violence based solely on prior realizations. Deviations from these predictions identify months with unexpectedly high violence, which we interpret as public safety shocks. We combine this approach with nationwide administrative transaction data from the National Banking and Securities Commission covering all municipalities over the same period. Preliminary evidence points to a dynamic behavioral response to unanticipated violence. In the month of exposure, ATM transaction intensity declines relative to historical norms, consistent with short-run disruption in financial activity. However, this contraction appears temporary. In subsequent months, aggregate ATM withdrawals increase, suggesting possible precautionary liquidity adjustments. We also document substitution across financial access channels, with activity shifting away from in-branch banking toward out-of-branch options, particularly banking correspondents.Taken together, these early findings suggest that localized insecurity reshapes how individuals access formal financial services rather than simply reducing participation. By isolating unanticipated violence shocks and tracing their short-run effects across financial channels, this study aims to provide new evidence on the indirect costs of insecurity for financial intermediation and financial inclusion in high-risk environments.
