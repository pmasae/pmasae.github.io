...
- **Banking Amidst Conflict: How Violence Shapes Financial Inclusion in Mexico** -- with Xiaofei Wang (Draft in progress)
	...
	**Abstract:** 
	We study how exposure to violence shapes the use of formal financial services in Mexico. Using administrative records on violent incidents, we construct municipality-level out-of-sample predictions of violence based solely on prior realizations. Deviations from these predictions identify months with unexpectedly high violence, which we interpret as public safety shocks. We combine this approach with nationwide administrative transaction data from the National Banking and Securities Commission covering all municipalities over the same period. Preliminary findings indicate that unexpected spikes in violence generate heterogeneous responses across financial access channels. While ATM transaction intensity declines following shocks, correspondent banking volumes increase, particularly in terms of total transaction amounts per capita. These increases are driven primarily by higher transaction values rather than higher transaction frequency, pointing to an intensive-margin response consistent with heightened precautionary liquidity demand. These patterns suggest that insecurity does not uniformly reduce formal financial engagement but instead alters the composition of access points, potentially reflecting substitution toward perceived safer or more accessible channels.
